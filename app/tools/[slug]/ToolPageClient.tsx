    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-10 bg-background text-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-3">
          ...
          <button onClick={handleValidate} className="btn-green">Validate</button>
          <button onClick={handleRun} className="btn-green">Run</button>
          <button onClick={handleMinify} className="btn-green">Minify</button>
          <button onClick={handleCopy} className="btn-dark">Copy</button>
          <button onClick={handleDownload} className="btn-dark">Download</button>

          <button
            onClick={handleClear}
            className="border border-border rounded-lg py-2 hover:bg-card transition"
          >
            Clear
          </button>
        </div>
